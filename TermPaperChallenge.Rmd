...
=======
  ...
  sampsize = head(grid_result_manual$sample_size,1) *nrow(data_manual))
>>>>>>> Stashed changes
...
=======
  ...
  sampsize = head(grid_result_website$sample_size,1)*nrow(data_website))
})
tail(final_model_manual$mse,1)
tail(final_model_website$mse,1)

predict(final_model_manual, tail(data_manual %>% select(-Date,-NextDayLeads.Manual),10))
>>>>>>> Stashed changes
```
